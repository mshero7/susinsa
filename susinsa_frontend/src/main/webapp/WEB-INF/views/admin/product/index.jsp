			...
			<table class="table">
				<thead>
					<tr>
						...
						<th scope="col">상품 기본가격</th>
						<th scope="col">상품 판매 상태</th>
						<th scope="col">등록일</th>
						<th scope="col"></th>
						<th scope="col"></th>
					</tr>
				...
				<tbody>
					<c:forEach items="${product_list}" var="vo" varStatus="status">
						<tr>
							...
							<td><button type="button" class="btn btn-danger">상품 삭제</button></td>
							<td><button type="button" class="btn btn-info">상품 상세 정보</button></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
